...
namespace flowerApiFinal.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        {
            //get floweritem from order details
            var orderDetails = await (from master in _context.Set<OrderMaster>()
                                      ...
                                      join flowerItem in _context.Set<FlowerItem>()
                                      on detail.FlowerItemId equals flowerItem.FlowerItemId
                                      ...
                                      select new
                                      {
                                          ...
                                          detail.FlowerItemId,
                                          detail.Quantity,
                                          detail.FlowerItemPrice,
                                          flowerItem.FlowerItemName
                                      }).ToListAsync();
        ...
        public async Task<IActionResult> PutOrderMaster(long id, OrderMaster orderMaster)
        {
            ...
            //existing flower items & newly added food items

    ...
    public partial class FirstCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FlowerItemId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FlowerItemName = table.Column<string>(type: "nvarchar(100)", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlowerItems", x => x.FlowerItemId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderMasterId = table.Column<long>(type: "bigint", nullable: false),
                    FlowerItemId = table.Column<int>(type: "int", nullable: false),
                    FlowerItemPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_FlowerItems_FlowerItemId",
                        column: x => x.FlowerItemId,
                        principalTable: "FlowerItems",
                        principalColumn: "FlowerItemId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_FlowerItemId",
                table: "OrderDetails",
                column: "FlowerItemId");
